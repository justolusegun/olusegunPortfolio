  ...
  return (
    <Container>
      ...
      <AboutContainer>
        ...
        <Code>&lt;h1&gt;</Code>
        <Text>
          19y/o Software Engineer creating intuitive and user-friendly
          experiences.
        </Text>
        <Code>&lt;/h1&gt;</Code>
        <Space></Space>
        <Code>&lt;p&gt;</Code>
        <SText>
          Hi There, <Color>I'm Olusegun</Color> <br />A software engineer based
          in Nigeria 🇳🇬 I'm an ambitious developer with a passion for creating
          intuitive and user-friendly experiences. I specialise in building
          frontend web applications and mobile ios applications with a focus on
          usabilty and simplicity.
        </SText>
        <Code>&lt;/p&gt;</Code>
        <Space></Space>
        <Icons>
          <a
            className="icon"
            href="http://github.com/justolusegun"
            target="_blank"
          >
            <GitHubIcon />
          </a>
          <a
            className="icon"
            href="https://twitter.com/yoursoftwareguy"
            target="_blank"
          >
            <TwitterIcon />
          </a>
          <a
            className="icon"
            href="https://www.linkedin.com/in/justolusegun/"
            target="_blank"
          >
            <LinkedInIcon />
          </a>
          <a
            className="icon"
            href="https://www.instagram.com/your.softwareguy"
            target="_blank"
          >
            <InstagramIcon />
          </a>
        ...
        <Technology>
          ...
          <TechL>
            ...
            <TechBox className="skillbox">Elementor</TechBox>
